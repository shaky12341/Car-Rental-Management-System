	...
	if( isset($_SESSION['optDeleteCategory'])) {
		$opt = "
			<div style='text-align:center;'>
				<span class='lead'>Are You Sure You Want $_SESSION[categoryName]?</span>
				<div class='alert alert-info'>
				<a href='Categories_real.php?CategoryID=$_SESSION[del_id]'><button class='btn btn-danger btn-lg'>Yes</button></a> | <a href='Categories_real.php'><button class='btn btn-primary btn-lg'>No</button></a>
				</div>
			</div>
		";
		$_SESSION['optDeleteCategory'] = null;
